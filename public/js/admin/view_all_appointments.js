...
const FLASK_MIDDLEWARE_URL =
  window.FLASK_MIDDLEWARE_URL || "http://localhost:5000";

async function updateFlaskStatusIndicator() {
  const statusBadge = document.getElementById("flaskStatusBadge");
  const statusText = document.getElementById("flaskStatusText");
