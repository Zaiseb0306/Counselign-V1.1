...
class CounselorEmailTemplates
{
    ...
    /**
     * Create HTML email body for appointment reschedule notification
     * 
     * @param array $appointmentData The appointment data
     * @param array $counselorData The counselor details
     * @return string The HTML email body
     */
    public static function createRescheduleEmailBody(array $appointmentData, array $counselorData): string
    {
        $counselorName = $counselorData['name'] ?? 'Your Counselor';
        $counselorEmail = $counselorData['email'] ?? '';
        $counselorId = $counselorData['counselor_id'] ?? '';
        
        $oldDate = date('F j, Y', strtotime($appointmentData['old_date'] ?? $appointmentData['preferred_date']));
        $oldTime = $appointmentData['old_time'] ?? $appointmentData['preferred_time'];
        $newDate = date('F j, Y', strtotime($appointmentData['preferred_date']));
        $newTime = $appointmentData['preferred_time'];
        $consultationType = $appointmentData['consultation_type'];
        $purpose = $appointmentData['purpose'];
        $description = $appointmentData['description'] ?? 'No additional description provided.';
        $rescheduleReason = $appointmentData['reason'] ?? 'No reason provided.';
        ...
        <head>
            ...
            <style>
                ...
                .counselor-info { background-color: white; padding: 15px; margin: 15px 0; border-radius: 5px; border-left: 4px solid #007bff; }
                .reschedule-info { background-color: #fff3cd; padding: 15px; margin: 15px 0; border-radius: 5px; border-left: 4px solid #ffc107; }
                .footer { text-align: center; margin-top: 20px; color: #666; font-size: 12px; }
        ...
        <body>
            <div class='container'>
                ...
                <div class='content'>
                    ...
                    <p>Your appointment has been rescheduled by your counselor. Please review the updated details below:</p>
                    
                    <div class='reschedule-info'>
                        <h3>⚠️ Reschedule Details</h3>
                        <p><span class='label'>Reason:</span><span class='value'>{$rescheduleReason}</span></p>
                        <p class='highlight'>Please take note of your new appointment schedule.</p>
                    </div>
                    
                    <div class='appointment-details'>
                        <h3>📋 Appointment Details</h3>
                        <p><span class='label'>Previous Date:</span><span class='value'>{$oldDate} at {$oldTime}</span></p>
                        <p class='highlight'><span class='label'>New Date:</span><span class='value'>{$newDate} at {$newTime}</span></p>
                        <p><span class='label'>Consultation Type:</span><span class='value'>{$consultationType}</span></p>
                        <p><span class='label'>Purpose:</span><span class='value'>{$purpose}</span></p>
                        <p><span class='label'>Description:</span><span class='value'>{$description}</span></p>
                    </div>
                    ...
                    <p>If you have any concerns about the rescheduled appointment, please contact your counselor.</p>
    ...
    /**
     * Create plain text email body for appointment reschedule notification
     * 
     * @param array $appointmentData The appointment data
     * @param array $counselorData The counselor details
     * @return string The plain text email body
     */
    public static function createRescheduleEmailTextBody(array $appointmentData, array $counselorData): string
    {
        $counselorName = $counselorData['name'] ?? 'Your Counselor';
        $counselorEmail = $counselorData['email'] ?? '';
        $counselorId = $counselorData['counselor_id'] ?? '';
        ...
        return "APPOINTMENT RESCHEDULE NOTIFICATION\n\n" .
               "Dear Student,\n\n" .
               "Your appointment has been rescheduled by your counselor. Please review the updated details below:\n\n" .
               "RESCHEDULE DETAILS:\n" .
               "Reason: {$rescheduleReason}\n" .
               "Please take note of your new appointment schedule.\n\n" .
               "APPOINTMENT DETAILS:\n" .
               ...
               "Email: {$counselorEmail}\n" .
               "Counselor ID: {$counselorId}\n\n" .
               "If you have any concerns about the rescheduled appointment, please contact your counselor.\n\n" .
               "Best regards,\n" .
               "Counselign System\n\n" .
               "This is an automated notification from Counselign - The USTP Guidance Counseling Sanctuary.\n" .
               "Please do not reply to this email.";
