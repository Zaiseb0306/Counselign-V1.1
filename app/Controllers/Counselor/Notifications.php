...
class Notifications extends \CodeIgniter\Controller
{
    ...
    public function history()
    {
        ...
        return view('counselor/notification_history');
    }
    ...
    public function getHistory()
    {
        ...
        try {
            ...
            try {
                ...
                log_message('error', 'Error getting read events: ' . $e->getMessage());
            }
            ...
            try {
                ...
                log_message('error', 'Error getting read announcements: ' . $e->getMessage());
            }
