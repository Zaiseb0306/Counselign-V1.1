...
class ForgotPassword extends Controller
{
    public function sendCode()
    {
        ...
        // Send email via PHPMailer using centralized configuration
        ...
        try {
            ...
            $mail->SMTPSecure = $emailConfig->SMTPCrypto === 'tls' ? PHPMailer::ENCRYPTION_STARTTLS : PHPMailer::ENCRYPTION_SMTPS;
            $mail->Port = $emailConfig->SMTPPort;
            $mail->Timeout = $emailConfig->SMTPTimeout;
            $mail->SMTPKeepAlive = $emailConfig->SMTPKeepAlive;
            ...
            $mail->Priority = $emailConfig->priority;
            ...
            return $this->response->setJSON(['status'=>'error','message'=>'Failed to send reset email. Please try again later.']);
        }
    }
