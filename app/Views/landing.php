                ...
                <div class="modal-body">
                    ...
                    <div class="row g-2 mb-3">
                        <div class="col-12 col-md-5">
                            <label for="c_info_firstname" class="form-label">First Name</label>
                            <input type="text" id="c_info_firstname" class="form-control" placeholder="First name">
                        </div>
                        <div class="col-12 col-md-5">
                            <label for="c_info_lastname" class="form-label">Last Name</label>
                            <input type="text" id="c_info_lastname" class="form-control" placeholder="Last name">
                        </div>
                        <div class="col-12 col-md-2">
                            <label for="c_info_mi" class="form-label">M.I. <small class="text-muted">(opt.)</small></label>
                            <input type="text" id="c_info_mi" class="form-control" placeholder="M.I." maxlength="3">
                        </div>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="c_info_region" class="form-select mb-1">
                            <option value="">Select Region</option>
                        </select>
                        <select id="c_info_province" class="form-select mb-1" disabled>
                            <option value="">Select Province</option>
                        </select>
                        <select id="c_info_city" class="form-select mb-1" disabled>
                            <option value="">Select City/Municipality</option>
                        </select>
                        <select id="c_info_barangay" class="form-select mb-1" disabled>
                            <option value="">Select Barangay</option>
                        </select>
                        <input type="text" id="c_info_street" class="form-control" placeholder="Street name, building, floor/unit no. (optional)">
                        <input type="hidden" id="c_info_address">
                    </div>
                    <div class="mb-3">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <input id="signUpUserIdInput" type="text" placeholder="Preferred User ID" class="form-control"
                            minlength="10" maxlength="10" pattern="[0-9]{10}" title="User ID must be exactly 10 digits.">
                    </div>
                    <div class="mb-3">
                    ...
                    <div id="passwordStrengthMeter" class="mb-3 d-none">
                        <div class="strength-meter">
                            <div class="strength-meter-fill" id="strengthMeterFill"></div>
                        </div>
                        <div class="strength-info">
                            <span id="strengthLabel" class="strength-label"></span>
                            <span id="strengthDescription" class="strength-description" data-weak="Use at least 8 characters with letters and numbers" data-moderate="Add special characters (!@#$%^&*) for better security" data-strong="Your password is strong!"></span>
                        </div>
                    </div>
                    <div class="mb-3 position-relative">
